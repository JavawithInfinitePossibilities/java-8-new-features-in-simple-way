...
public class Chapter13StreamsApplication {
	...
	public static void main(String[] args) {
		 ...
		 * Result :ohW si eht tsedlo eeyolpme ni eht ?noitazinagro0
		 * 
		 */
		String value = "Who is the oldest employee in the organization?";
		String result = Arrays.stream(value.split(" ")).map(eachWord -> {
			return new StringBuilder(eachWord).reverse() + " ";
