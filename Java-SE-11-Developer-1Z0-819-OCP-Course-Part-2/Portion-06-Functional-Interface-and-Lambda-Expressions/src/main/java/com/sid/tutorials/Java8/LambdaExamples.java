...
public class LambdaExamples {
	...
	private static Viewable staticViewable = () -> System.out.println("Static Variable Lambda");

	private Viewable instanceViewable = () -> System.out.println("Instance Variable Lambda");
	...
	public static void main(String[] args) {
		...
		for (String s : new String[] { "First", "Second", "Third" }) {
			viewIt(() -> System.out.println("Lambda Expression" + " on the fly " + s));
		}
	}
