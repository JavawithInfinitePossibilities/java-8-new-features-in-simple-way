...
public class OuterMost {
	...
	public class PublicInner {
		...
		public PublicInner() {
			...
			System.out.println("PublicInner instantiated, OuterString = " + OuterString);
			// reference enclosing object's fields with class name & this
			System.out.println("PublicInner instantiated, OuterString = " + OuterMost.this.OuterString);
		}
		...
		public class NestedInnerSecondLevel {
			public NestedInnerSecondLevel() {
				...
				// reference enclosing object's fields with simple name
				System.out.println("NestedInnerSecondLevel instantiated," + " OuterString = " + OuterString);

				// reference enclosing object's fields with class name & this
				System.out.println(
						"NestedInnerSecondLevel instantiated," + " OuterString = " + OuterMost.this.OuterString);

				// reference enclosing object's fields with simple name
				System.out.println("NestedInnerSecondLevel instantiated," + " InnerString = " + InnerString);

				// reference enclosing object's fields with class name & this
				System.out.println("NestedInnerSecondLevel instantiated," + " InnerString = "
						+ OuterMost.PublicInner.this.InnerString);
...
class InnerClassExtras {
	public static void main(String[] args) {
		...
		OuterMost.PublicInner.NestedInnerSecondLevel nested = publicInner.new NestedInnerSecondLevel();

		OuterMost.PublicInner.NestedInnerSecondLevel alternate = new OuterMost().new PublicInner().new NestedInnerSecondLevel();
	}
}