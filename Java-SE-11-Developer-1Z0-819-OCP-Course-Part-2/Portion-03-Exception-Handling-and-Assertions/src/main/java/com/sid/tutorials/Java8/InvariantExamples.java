...
public class InvariantExamples {
	...
	public static void main(String[] args) {
		...
		for (PetType pt : PetType.values()) {
			...
			System.out.println("A juvenile " + pt + " is called a " + ex.getPetTypeDietaryNeeds(pt));
		}
	}
	...
	public String getPetTypeAgeDescription(PetType petType, int petAge) {
		...
		assert (new ArrayList(Arrays.asList(new String[] { "ADULT", "SENIOR", "KITTEN", "PUPPY", "PUP" }))
				.indexOf(description) > -1) : "No Description exists for " + petType + " age " + petAge;
