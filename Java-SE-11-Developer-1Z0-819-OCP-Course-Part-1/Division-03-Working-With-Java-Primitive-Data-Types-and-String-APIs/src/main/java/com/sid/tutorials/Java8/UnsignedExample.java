...
public class UnsignedExample {
	public static void main(String[] args) {
		...
		// we are going to purposely overflow our variable in testInt. Our value is
		// Integer.MAX_VALUE+3;
		int testInt = (int) (Integer.MAX_VALUE + 3); // integer overflows by 3
		System.out.println("Casting to an int, value  = " + testInt);

		// Let's set the value to a long, which will represent our number without
		// overflowing
		...
		// We can also take the same number, wrapped in a String, and pass it to the
