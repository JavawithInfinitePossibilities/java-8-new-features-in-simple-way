...
/*
 * Learn Programming Academy's Java 1Z0-815 Certification Exam Course Section 6:
 * Describing and Using Objects and Classes Topic: Declare and Instantiate
 * Objects Sub-Topic: Declaring and Accessing Fields
 */
class SuperClass {
	static String name;
	String instanceName;
