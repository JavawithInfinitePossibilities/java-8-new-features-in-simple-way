...
public class BinaryOperatorExamples {
	...
	public static void main(String[] args) {
		...
		// dividend < divisor.
		System.out.println("Modulus examples where integer divisor" + " > integer dividend");
		for (int i = 0; i <= 9; i += 3) {
		...
		System.out.println("Modulus examples where double divisor " + "> double dividend");
		...
		try {
			System.out.println("Modulus with zero divisor (10.0 % 0.0) = " + (10.0 % 0.0));
		} catch (Exception ex) {
			ex.printStackTrace(System.out);
		}
		...
		System.out.println("result of signed right shift   (" + "10000010_00000010_00000010_00000010 >>  1 ) = "
				+ String.format("%32s", Integer.toBinaryString(0b10000010_00000010_00000010_00000010 >> 1)).replace(' ',
						'0'));
		...
		System.out.println("Conditional Logical || evaluates only first " + "expression if it evaluates to true: e = "
				+ e + ", and f = " + f);
		...
		System.out.println("Conditional Logical || (OR) will evaluate"
				+ " both expressions ONLY if first expression is false : e = " + e + ", and f = " + f);
		...
		System.out.println("Logical & (AND) will evaluate both expressions: a = " + a + ", and b = " + b);
		...
		System.out.println("Conditional && (AND) will evaluate only first "
				+ "expression if it evaluates to false: a = " + a + ", and b = " + b);
		...
		System.out.println("Conditional && (AND) will evaluate both " + "expressions if first evaluates to true: a = "
				+ a + ", and b = " + b);
	}
