...
public class NarrowExample {
	public static void main(String[] args) {
		...
		System.out.println("A char has a range of "
				+ String.format("\\u%04x  to \\u%04x", (int) Character.MIN_VALUE, (int) Character.MAX_VALUE));
		...
		// Implicit narrowing can no longer be done because the literal does not fit the
		// container it is assigned to.
//	        byte b1 = 128;
//	        char c1 = 65536;
//	        short s1 = 32768;
