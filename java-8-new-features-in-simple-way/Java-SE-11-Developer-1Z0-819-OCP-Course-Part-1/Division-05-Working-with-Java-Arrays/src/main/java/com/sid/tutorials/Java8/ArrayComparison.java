...
public class ArrayComparison {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n------------- Arrays.equals ------------");
		System.out.println(
				" (Arrays.equals(firstString,copyOfFirstString)) = " + Arrays.equals(firstString, copyOfFirstString));
		...
		System.out.println("\n------------- Arrays.compare ------------");
		System.out.println(
				" (Arrays.compare(firstString,copyOfFirstString)) = " + Arrays.compare(firstString, copyOfFirstString));
		...
		// If we compare the first elements, we get the same result as comparing the
		// full arrays...
		System.out.println("firstString[0].compareTo(firstStringUnsorted[0]  = "
				+ firstString[0].compareTo(firstStringUnsorted[0]));

		// New String array, only first 3 elements are shared with firstString - the
		// prefix.
		...
		// Verify that above result is same as comparing elements at first non-matching
		// index..
