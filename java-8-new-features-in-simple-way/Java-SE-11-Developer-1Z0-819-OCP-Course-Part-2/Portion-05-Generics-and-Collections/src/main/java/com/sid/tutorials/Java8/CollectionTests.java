...
public class CollectionTests {
	...
	private static void performBulkFunctionsString(Collection<String> h) {
		...
		System.out.println(
				"containAll(Fred ,Harry, Isabel) : " + h.containsAll(List.of("Fred", "Harry", "Isabel")) + " : " + h);
		System.out.println(
				"containAll(Anne ,Harry, Isabel) : " + h.containsAll(List.of("Anne", "Harry", "Isabel")) + " : " + h);
		try {
		...
		try {
			System.out.println(
					"After retainAll:" + h.retainAll(List.of("Barry", "Charles", "David", "Edward")) + " : " + h);
		} catch (Exception e) {
